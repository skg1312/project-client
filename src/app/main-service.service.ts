...
export class MainServiceService {
  ...
  baseURL:string="167.71.225.230"

  public addContact( contact : any, callback : any ){
    this.httpClient.post("167.71.225.230/ajes/contact",contact)
                  .subscribe((data:any)=>{
                      callback(data);
                  }
                  )
  ...
  public addCareer( career : any, callback : any){
    console.log(career);
    this.httpClient.post("167.71.225.230/ajes/careers",career)
                  .subscribe((data : any)=>{
                    callback(data);
                  })
  }
 ...
 public addDemo( demo : any, callback : any){
  console.log(demo);
  this.httpClient.post("167.71.225.230/ajes/demo",demo)
                  .subscribe((data : any)=>{
                    callback(data);
                  })
 }
  ...
  public addLogin( login : any, callback : any ){
    this.httpClient.post("167.71.225.230/ajes/login",login)
                  .subscribe((data:any)=>{
                      callback(data);
                  }
                  )
  ...
  public logIn(login : any,callback : any){
    console.log(login);
    this.httpClient.post("167.71.225.230/ajes/logging1",login)
                    .subscribe(
                      (data: any) => {
                        callback(data);
...
private openErrorSnackBar(message: string): void {
 ...
 public getUserByUserName(userName : any,callback : any){
     this.httpClient.get("167.71.225.230/ajes/user"+userName)
                    .subscribe((data : any)=>{
                       console.log(data);
                       callback(data);
                    })
